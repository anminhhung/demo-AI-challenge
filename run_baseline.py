...
from src.detect import build_detector_v3, build_detector_detectron
...
class VideoTracker(object):
    def __init__(self, cfg, args):
        ...
        self.detector = build_detector_detectron(cfg)
...
def parse_args():
    ...
    parser.add_argument("--config_detection", type=str, default="./configs/detectron.yaml")
